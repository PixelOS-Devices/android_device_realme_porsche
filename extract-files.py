...
lib_fixups: lib_fixups_user_type = {
    **lib_fixups,
    ('libextendfile'): lib_fixup_odm_suffix,
}

blob_fixups: blob_fixups_user_type = {
    'odm/etc/camera/CameraHWConfiguration.config': blob_fixup()
        .regex_replace('SystemCamera =  0;  0;  1;  1;  1', 'SystemCamera =  0;  0;  0;  0;  1'),
    ('odm/lib64/libSuperRaw.so', 'odm/lib64/libYTCommon.so', 'odm/lib/liblvimfs_wrapper.so', 'odm/lib64/libCOppLceTonemapAPI.so', 'odm/lib64/libaps_frame_registration.so', 'vendor/lib64/libalsc.so'): blob_fixup()
    ...
    'odm/lib64/libAlgoProcess.so': blob_fixup()
        ...
        .replace_needed('libextendfile.so', 'libextendfile_odm.so'),
